package com.thirdsense.utils
{
	...
	public class Trig {
		...
		public static function findPoint(angle:Number, distance:Number):Point {
			
			// Returns a co-ordinate of a point [distance] at [angle] from point 0,0
			
			var myPoint:Point = new Point();
			
			myPoint.x = Math.sin((Math.PI / 180) * angle) * distance;
			myPoint.y = (Math.cos((Math.PI / 180) * angle) * -1) * distance;
